...
<img src="../../assets/images/guide/python/python-logo.svg" alt="Python logo" width="120" style="float: right; margin: 0 0 1rem 1rem;">
...
![Thonny IDE interface](../../assets/images/guide/python/thonny-ide.png)
